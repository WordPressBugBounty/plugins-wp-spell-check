...
class Wpscx_Table extends WP_List_Table {
	...
	function column_page_name( $item ) {
		...
		} elseif ( 'Media Title' === $item['page_type'] || 'Media Description' === $item['page_type'] || 'Media Caption' === $item['page_type'] || 'Media Alternate Text' === $item['page_type'] || 'Page Excerpt' === $item['page_type'] || 'Post Excerpt' === $item['page_type'] ) {
			$output = '<a href="' . esc_url( wpscx_get_post_edit_url( (int) $item['page_id'] ) ) . '" id="wpsc-page-name" page="' . esc_attr( $item['page_id'] ) . '" title="' . esc_attr( $item['page_name'] ) . '" target="_blank">View</a>';
