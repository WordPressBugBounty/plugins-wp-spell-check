...
function wphcx_admin_render() {
	...
	<div class="wrap wpsc-table wpsc-html-results-page wpsc-page-html">
							...
							if ( ( ( $post_count + $page_count ) > $max_pages ) & $wpscx_ent_included ) {
								...
								<h3 class='sc-message error'>You have more than
									<?php echo esc_attr( $max_pages ); ?> Pages/Posts. <a
										href='https://www.wpspellcheck.com/product-tour/?utm_source=baseplugin&utm_campaign=&utm_medium=bc_scan&utm_content=<?php echo esc_attr( isset( $wpsc_version ) ? $wpsc_version : '11.2' ); ?>'
		...
		<?php } else { ?>
			...
			?>
			<h3><a href="https://www.wpspellcheck.com/product-tour/?utm_source=baseplugin&utm_campaign=upgradeBroken_code&utm_medium=bc_scan&utm_content=<?php echo esc_attr( isset( $wpsc_version ) ? $wpsc_version : '11.2' ); ?>"
