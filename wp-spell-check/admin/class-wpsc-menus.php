...
class Wpscx_Menu {
	...
	function add_network_menu() {
			add_submenu_page( 'settings.php', 'WP Spell Check Database Cleanup and Deactivation', 'WP Spell Check Database Cleanup and Deactivation', 'manage_options', 'wpsc_uninstall_page', 'wpscx_uninstall_page' );
	}
	...
	function add_toolbar_menu( $wp_admin_bar ) {
			...
			$args = array(
				...
				'href'   => $site_url . '/wp-admin/admin.php?page=wp-spellcheck.php&wpsc-trigger-scan=1',
				'meta'   => array( 'class' => 'wpsc-toolbar-page' ),
