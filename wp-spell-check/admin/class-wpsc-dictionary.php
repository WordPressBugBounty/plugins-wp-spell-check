...
function wpscx_dictionary_render() {
	...
	<div class="wrap wpsc-table">
		...
		if ( '' !== $added_message && strpos( $added_message, ', ' ) !== false ) {
			echo "<span class='wpsc-message' style='font-size: 1.3em; color: rgb(0, 115, 0); font-weight: bold; float: left; width: 100%; line-height: 1.5em;'>" . esc_html( $added_message ) . ' have been added to the dictionary</span>';
