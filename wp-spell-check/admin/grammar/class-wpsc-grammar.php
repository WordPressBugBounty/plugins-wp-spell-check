...
class Wpscx_Grammar_Scanner extends wpscx_scanner {
	...
	function check_posts() {
		...
		// phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared -- Table name is safe: $wpdb->prefix . 'posts', $post_status and $post_type_list are constructed from hardcoded values
