...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-ignore-checkbox").on("click", function (event) {
  ...
  jQuery(".wpsc-add-checkbox").on("click", function (event) {
    var parent = jQuery(this).closest(".wpsc-row");
    var parent_id = parent.attr("id").split("-")[2];
  ...
  jQuery(".wpsc-dictionary-edit-button").on("click", function (event) {
    ...
    jQuery(".wpsc-update-button").on("click", function () {
  ...
  jQuery(".wpsc-edit-button").on("click", function (event) {
    event.preventDefault();
    var parent = jQuery(this).closest(".wpsc-row");
    var old_word = jQuery(this).attr("id").split("-")[2];
    ...
    jQuery(document).ready(function () {
      ...
      jQuery(".wpsc-mouseover-pro-feature-3").on("click", function () {
  ...
  jQuery(".wpsc-edit-seo-button").on("click", function (event) {
    event.preventDefault();
    var parent = jQuery(this).closest(".wpsc-row");
    var old_word = jQuery(this).attr("id").split("-")[2];
    var old_word_id = jQuery(this).closest("tr").attr("id").split("-")[2];
    ...
    if (typeof wpscx_seoListener === "function") {
      wpscx_seoListener();
    }
  ...
  jQuery(".wpsc-suggest-button").on("click", function (event) {
    event.preventDefault();
    var parent = jQuery(this).closest(".wpsc-row");
    var old_word_id = jQuery(this).closest("tr").attr("id").split("-")[2];
    var old_word = jQuery("#wpsc-row-" + old_word_id)
    ...
    jQuery(document).ready(function () {
      ...
      jQuery(".wpsc-mouseover-pro-feature-2").on("click", function () {
        if (!mouseover_visible_edit) {
  ...
  jQuery("#wpsc-edit-update-button-hidden").on("click", function (event) {
    event.preventDefault();
    var old_word_ids = "";
  ...
  jQuery(".wpsc-update-suggest-button").on("click", function () {
    var old_word_ids = "";
...
function wpscx_add_event_handlers() {
  jQuery(".edit-seo-title").on("keydown", function () {
  ...
  jQuery(".edit-seo-desc").on("keydown", function () {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-button-post").on("click", function () {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-button-refresh").on("click", function () {
    if (!mouseover_visible) {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-button-change").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
      var scrollTop = jQuery(window).scrollTop();
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-button-page").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-pro-feature").on("click", function () {
    if (!mouseover_visible) {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-button-freq").on("click", function () {
    if (!mouseover_visible) {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-email").on("click", function () {
    if (!mouseover_visible) {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-import").on("click", function () {
    if (!mouseover_visible) {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-export").on("click", function () {
    if (!mouseover_visible) {
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-scfeature").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-scfeature-2").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-emfeature-seo").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-emfeature").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-emfeature-2").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
...
jQuery(document).ready(function () {
  ...
  jQuery(".wpsc-mouseover-emfeature-3").on("click", function () {
    if (!mouseover_visible) {
      var buttonOffset = jQuery(this).offset();
